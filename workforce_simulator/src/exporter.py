...
def result_to_dict(result: SimulationResult) -> dict:
    ...
    return {
        ...
        "is_valid_team": result.is_valid_team,
        "invalid_reasons": result.invalid_reasons,
        "total_score": result.total_score,
        "skill_coverage_score": result.skill_coverage_score,
        "required_skill_coverage_score": result.required_skill_coverage_score,
        "optional_skill_coverage_score": result.optional_skill_coverage_score,
        ...
        "task_schedule": [a.schedule_dict() for a in result.assignments],
        ...
        rows.append(
            {
                ...
                "is_valid_team": r.is_valid_team,
                "invalid_reasons": "; ".join(r.invalid_reasons),
                "total_score": r.total_score,
                "skill_coverage_score": r.skill_coverage_score,
                "required_skill_coverage_score": r.required_skill_coverage_score,
                "optional_skill_coverage_score": r.optional_skill_coverage_score,
                "capacity_fit_score": r.capacity_fit_score,
                "estimated_cost": r.estimated_cost,
                "estimated_duration": r.estimated_duration,
                "critical_path": " -> ".join(r.critical_path),
                ...
                "missing_required_skills": "|".join(r.missing_required_skills),
                "missing_optional_skills": "|".join(r.missing_optional_skills),
